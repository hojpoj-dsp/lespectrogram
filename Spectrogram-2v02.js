...
class Spectrogram {
  constructor(ipObj, w, h, sgMode, rhc, vert, options) {
    ...
    let startOfs = 0;
    let nextLine = 0;
    let demoCvsId = null;  // for diagnostics only
    let timerID = null;
    let running = false;
    let sgTime = 0;
    let sgStartTime = 0;
...
class Waterfall extends Spectrogram {
...
class Rasterscan extends Spectrogram {
  constructor(ipObj, w, h, dir, options)   // ipObj = {buffer: [..]}
  {
